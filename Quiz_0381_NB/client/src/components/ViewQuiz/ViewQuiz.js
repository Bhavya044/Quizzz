            ...
            <div className="view-quiz">
                ...
                <div className="content">
                    <div className="header">
                        {this.state.quiz.name}, Duration:{this.state.quiz.duration} minutes per question
                    </div>
                    <div className="body">
                        <div className="left">
                            ...
                            <div className="comments">
                                {this.state.quiz.comments.map((com, idx) => (
                                    <div className="comment" key={idx}>
                                        <img alt='' style={{borderRadius: '100%'}} className="img" src="https://img.pngio.com/png-avatar-108-images-in-collection-page-3-png-avatar-300_300.png" />
                                        <div>{com.message}</div>
                                        <div>{com.sentFromName}</div>
                                    </div>
                                ))}
                                <div className="input-field">
                                    <input value={this.state.inputVal} onChange={e => this.setState({inputVal: e.target.value})} type="text" placeholder="Add new chat" />
